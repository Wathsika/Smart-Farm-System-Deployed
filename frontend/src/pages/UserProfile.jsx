...
// ⬇️ Add your shared header & footer (same paths you used before)
import Header from '../components/common/Header';
import Footer from '../components/common/Footer';

// --- Reusable UI cards (unchanged) ---
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="md:col-span-1 space-y-4">
              ...
              <Link
                to="/my-orders"
                className="flex items-center gap-3 px-4 py-3 text-gray-700 font-medium rounded-lg hover:bg-green-100 hover:text-green-700"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 text-red-600 font-medium rounded-lg hover:bg-red-100"
              >
